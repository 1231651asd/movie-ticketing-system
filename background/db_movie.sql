...
INSERT INTO `cinemas` VALUES ('4', 'https://p0.meituan.net/mmdb/fd146c7848a0ebca36eb869dfef7c9331034607.png@292w_292h_1e_1c', '\r\n万影汇影城（华发中城荟店）', '江汉区青年路华发中城荟B9三楼（大兔子观光电梯三楼）', '改签/3D眼镜免押金/儿童优惠/可停车', '17771745650');
...
CREATE TABLE `movies`  (
  ...
  `is_deleted` int(11) NULL DEFAULT 0 COMMENT '状态',
...
-- Records of movies
-- ----------------------------
INSERT INTO `movies` VALUES ('1', '哥斯拉大战金刚2：帝国崛起', '动作,冒险,科幻', '亚当：温加德', '金刚/哥斯拉', 'https://p0.pipi.cn/mmdb/54ecde9a8d351b2c95d23c10d9b9fe0e83a1d.jpg?imageView2/1/w/464/h/644', '中国大陆', '继上一次的怪兽高燃对战之后，金刚和哥斯拉将再度联手对抗一个潜伏在世界中的巨大威胁，并逐步探索这些巨兽们的起源以及骷髅岛等地的奥秘。同时，上古之战的面纱也将会被揭晓，而正是那场战斗创造出了这些超凡的生物，并深刻影响了人类世界的命运。', '2024-03-29', 0);
INSERT INTO `movies` VALUES ('2', '灿烂的她', '剧情,家庭', '徐伟', '惠英红,刘浩存,张子贤/刘欢', 'https://p0.pipi.cn/mmdb/54ecde9a5bf0fa50c806d6be52dbfd4ee06ab.jpg?imageView2/1/w/464/h/644', '中国台湾', '慈祥宽容的奶奶（惠英红 饰）与十二年前意外走失的孙女（刘浩存 饰）重逢，祖孙二人从生疏到彼此依偎。相处期间，她们身上的秘密也逐渐被揭开。最终奶奶拯救了这个本对人生不抱希望的“孙女”。', '2024-03-15', 0);
...
CREATE TABLE `orders`  (
  ...
  `payment_status` int(11) NULL DEFAULT 0 COMMENT '支付状态(0-未支付 1-已支付)',
  ...
  `seat_row` int(11) NULL DEFAULT 0 COMMENT '座位行号',
  `seat_column` int(11) NULL DEFAULT 0 COMMENT '座位列号',
  PRIMARY KEY (`order_id`) USING BTREE,
  INDEX `user_id`(`user_id`) USING BTREE,
  INDEX `fk_orders_screens`(`screen_id`) USING BTREE,
...
CREATE TABLE `screens`  (
  ...
  `row_s` int(11) NULL DEFAULT 0 COMMENT '行数',
  `col_s` int(11) NULL DEFAULT 0 COMMENT '列数',
...
-- Records of screens
-- ----------------------------
INSERT INTO `screens` VALUES ('1', '1', 12, 5, '1', '09:00:00', '14:00:00', '2024-04-20', '一号厅', 56.00, 0);
INSERT INTO `screens` VALUES ('2', '1', 12, 5, '1', '11:00:00', '17:00:00', '2024-03-31', '二号厅', 56.00, 0);
INSERT INTO `screens` VALUES ('3', '2', 12, 5, '1', '12:00:00', '20:00:00', '2024-05-25', '一号厅', 56.00, 0);
INSERT INTO `screens` VALUES ('3b96bfdd64af9c144c193f1c032b1f94', '4', 0, 0, '1', '10:09:49', '12:09:49', '2024-04-26', '一号厅', 0.00, 0);
INSERT INTO `screens` VALUES ('4', '1', 12, 5, '3', '05:00:00', '09:00:00', '2024-05-30', '一号厅', 56.00, 0);
INSERT INTO `screens` VALUES ('5', '1', 12, 5, '3', '08:00:00', '09:00:00', '2024-04-28', '五号厅', 40.00, 0);
INSERT INTO `screens` VALUES ('520f107bf97703fbff14cb882ab479ed', '1', 0, 0, '2', '10:08:58', '12:08:58', '2024-04-24', '二号厅', 0.00, 0);
INSERT INTO `screens` VALUES ('c0ec9b9332b2ec568f7c09f8e4ef6418', '1', 0, 0, '3', '11:44:44', '14:30:44', '2024-04-30', '二号厅', 0.00, 0);
INSERT INTO `screens` VALUES ('e3de99d2361370c256ea3cb771557ec3', '2', 0, 0, '2', '21:39:47', '23:48:47', '2024-04-12', '三号厅', 0.00, 0);
...
INSERT INTO `users` VALUES ('11fafae3866baa6bd7b9ab1f46554f44', '517048575', '123', '2');
INSERT INTO `users` VALUES ('2', '2', '2', '2');
INSERT INTO `users` VALUES ('254e0c3924423d76521929b4d8b93096', '123', '123', '1');
